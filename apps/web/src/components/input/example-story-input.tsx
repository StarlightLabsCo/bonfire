...
import { Button, UndoButton, ProgressButton } from './buttons';
...
export function ExampleStoryInput({ scrollRef, className }: StoryInputProps) {
  ...
  const StageText = {
    ...
    [InstanceStage.GENERATE_ACTION_SUGGESTIONS_FINISH]: 'To enter custom actions, you must create an account.',
  };
