...
export function OpenSidebar() {
  ...
  if (showSidebarOpen) {
    return (
      <div
        className="z-10 absolute top-2 left-2 h-8 p-2 items-center justify-center rounded-md border bg-neutral-950 border-white/10 hover:cursor-pointer hidden md:flex"
        onClick={() => openSidebar()}
      >
